    ...
    return (
        ...
        <div className="d-flex justify-content-center flex-wrap">
          <div className="img-menu">
            <Link href="https://online.flippingbook.com/view/1007065914/" ><a target="_blank"><Image src={mexicomenu}></Image></a></Link>
          </div>
          <div className="img-menu">
            <Link href="https://globalreports.info/wolop/Aserlaco/1/1/1/1" ><a target="_blank"><Image src={ecuadormenu}></Image></a></Link>
          </div>
          <div className="img-menu" >
